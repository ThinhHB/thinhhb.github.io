...
ut.Core2D.layers.Background = function() {
};
ut.Core2D.layers.Background.prototype = Object.create(null);
ut.Core2D.layers.Background.prototype.constructor = ut.Core2D.layers.Background;
Object.defineProperties(ut.Core2D.layers.Background.prototype, {
});
ut.Core2D.layers.Background._size = 1;
ut.Core2D.layers.Background._fromPtr = function(ptr, v) {
  v = v || Object.create(ut.Core2D.layers.Background.prototype);
  return v;
};
ut.Core2D.layers.Background._toPtr = function(ptr, v) {
};
ut.Core2D.layers.Background._toTempHeapPtr = function(ptr, v) {
};
ut.Core2D.layers.Background._tempHeapPtr = function(v) {
  var ptr = ut.tempHeapPtrBufferZero(1);
  if (v) ut.Core2D.layers.Background._toTempHeapPtr(ptr, v);
  return ptr;
};
ut.Core2D.layers.Background.StorageView = function(ptr) {
  this._ptr = ptr;
};
ut.Core2D.layers.Background.StorageView.prototype = Object.create(null);
ut.Core2D.layers.Background.StorageView.prototype.constructor = ut.Core2D.layers.Background.StorageView;
ut.Core2D.layers.Background._view = ut.Core2D.layers.Background.StorageView;
ut.Core2D.layers.Background.StorageView._isSharedComp = ut.Core2D.layers.Background._isSharedComp = false;
ut.Core2D.layers.Background.StorageView._fromPtr = ut.Core2D.layers.Background._fromPtr;
ut.Core2D.layers.Background.StorageView._toPtr = ut.Core2D.layers.Background._toPtr;
ut.Core2D.layers.Background.StorageView._tempHeapPtr = ut.Core2D.layers.Background._tempHeapPtr;
ut.Core2D.layers.Background.StorageView._size = ut.Core2D.layers.Background._size;
ut.Core2D.layers.Background.StorageView.prototype.$advance = function() {
  this._ptr += 1;
};
Object.defineProperties(ut.Core2D.layers.Background.StorageView.prototype, {
});
ut.Core2D.layers.Background._dtorFn = function dtor(ptr) { /* POD, no-op */ }
// ut.Core2D.layers.Background is a POD type, so a JavaScript side copy constructor ut.Core2D.layers.Background._copyFn = function copy(src, dst) { ... } does not need to be generated for it
ut.Core2D.layers.Background._typeDesc = (function() {
  return ut.meta.allocType(5, 'ut.Core2D.layers.Background', 1, []);
})();
Object.defineProperties(ut.Core2D.layers.Background, { cid: { configurable: true, get: function() { delete ut.Core2D.layers.Background.cid; var offsetsPtr = 0, offsetsCount = 0; return ut.Core2D.layers.Background.cid = Module._ut_component_register_cid_with_type(ut.Core2D.layers.Background._typeDesc, 0, 0, offsetsPtr, offsetsCount, 0, 0); } } });
Object.defineProperties(ut.Core2D.layers.Background.StorageView, { cid: { configurable: true, get: function() { return ut.Core2D.layers.Background.cid; } } });
ut.Core2D.layers.Platform = function() {
};
ut.Core2D.layers.Platform.prototype = Object.create(null);
ut.Core2D.layers.Platform.prototype.constructor = ut.Core2D.layers.Platform;
Object.defineProperties(ut.Core2D.layers.Platform.prototype, {
});
ut.Core2D.layers.Platform._size = 1;
ut.Core2D.layers.Platform._fromPtr = function(ptr, v) {
  v = v || Object.create(ut.Core2D.layers.Platform.prototype);
  return v;
};
ut.Core2D.layers.Platform._toPtr = function(ptr, v) {
};
ut.Core2D.layers.Platform._toTempHeapPtr = function(ptr, v) {
};
ut.Core2D.layers.Platform._tempHeapPtr = function(v) {
  var ptr = ut.tempHeapPtrBufferZero(1);
  if (v) ut.Core2D.layers.Platform._toTempHeapPtr(ptr, v);
  return ptr;
};
ut.Core2D.layers.Platform.StorageView = function(ptr) {
  this._ptr = ptr;
};
ut.Core2D.layers.Platform.StorageView.prototype = Object.create(null);
ut.Core2D.layers.Platform.StorageView.prototype.constructor = ut.Core2D.layers.Platform.StorageView;
ut.Core2D.layers.Platform._view = ut.Core2D.layers.Platform.StorageView;
ut.Core2D.layers.Platform.StorageView._isSharedComp = ut.Core2D.layers.Platform._isSharedComp = false;
ut.Core2D.layers.Platform.StorageView._fromPtr = ut.Core2D.layers.Platform._fromPtr;
ut.Core2D.layers.Platform.StorageView._toPtr = ut.Core2D.layers.Platform._toPtr;
ut.Core2D.layers.Platform.StorageView._tempHeapPtr = ut.Core2D.layers.Platform._tempHeapPtr;
ut.Core2D.layers.Platform.StorageView._size = ut.Core2D.layers.Platform._size;
ut.Core2D.layers.Platform.StorageView.prototype.$advance = function() {
  this._ptr += 1;
};
Object.defineProperties(ut.Core2D.layers.Platform.StorageView.prototype, {
});
ut.Core2D.layers.Platform._dtorFn = function dtor(ptr) { /* POD, no-op */ }
// ut.Core2D.layers.Platform is a POD type, so a JavaScript side copy constructor ut.Core2D.layers.Platform._copyFn = function copy(src, dst) { ... } does not need to be generated for it
ut.Core2D.layers.Platform._typeDesc = (function() {
  return ut.meta.allocType(5, 'ut.Core2D.layers.Platform', 1, []);
})();
Object.defineProperties(ut.Core2D.layers.Platform, { cid: { configurable: true, get: function() { delete ut.Core2D.layers.Platform.cid; var offsetsPtr = 0, offsetsCount = 0; return ut.Core2D.layers.Platform.cid = Module._ut_component_register_cid_with_type(ut.Core2D.layers.Platform._typeDesc, 0, 0, offsetsPtr, offsetsCount, 0, 0); } } });
Object.defineProperties(ut.Core2D.layers.Platform.StorageView, { cid: { configurable: true, get: function() { return ut.Core2D.layers.Platform.cid; } } });
ut.Core2D.layers.Character = function() {
};
ut.Core2D.layers.Character.prototype = Object.create(null);
ut.Core2D.layers.Character.prototype.constructor = ut.Core2D.layers.Character;
Object.defineProperties(ut.Core2D.layers.Character.prototype, {
});
ut.Core2D.layers.Character._size = 1;
ut.Core2D.layers.Character._fromPtr = function(ptr, v) {
  v = v || Object.create(ut.Core2D.layers.Character.prototype);
  return v;
};
ut.Core2D.layers.Character._toPtr = function(ptr, v) {
};
ut.Core2D.layers.Character._toTempHeapPtr = function(ptr, v) {
};
ut.Core2D.layers.Character._tempHeapPtr = function(v) {
  var ptr = ut.tempHeapPtrBufferZero(1);
  if (v) ut.Core2D.layers.Character._toTempHeapPtr(ptr, v);
  return ptr;
};
ut.Core2D.layers.Character.StorageView = function(ptr) {
  this._ptr = ptr;
};
ut.Core2D.layers.Character.StorageView.prototype = Object.create(null);
ut.Core2D.layers.Character.StorageView.prototype.constructor = ut.Core2D.layers.Character.StorageView;
ut.Core2D.layers.Character._view = ut.Core2D.layers.Character.StorageView;
ut.Core2D.layers.Character.StorageView._isSharedComp = ut.Core2D.layers.Character._isSharedComp = false;
ut.Core2D.layers.Character.StorageView._fromPtr = ut.Core2D.layers.Character._fromPtr;
ut.Core2D.layers.Character.StorageView._toPtr = ut.Core2D.layers.Character._toPtr;
ut.Core2D.layers.Character.StorageView._tempHeapPtr = ut.Core2D.layers.Character._tempHeapPtr;
ut.Core2D.layers.Character.StorageView._size = ut.Core2D.layers.Character._size;
ut.Core2D.layers.Character.StorageView.prototype.$advance = function() {
  this._ptr += 1;
};
Object.defineProperties(ut.Core2D.layers.Character.StorageView.prototype, {
});
ut.Core2D.layers.Character._dtorFn = function dtor(ptr) { /* POD, no-op */ }
// ut.Core2D.layers.Character is a POD type, so a JavaScript side copy constructor ut.Core2D.layers.Character._copyFn = function copy(src, dst) { ... } does not need to be generated for it
ut.Core2D.layers.Character._typeDesc = (function() {
  return ut.meta.allocType(5, 'ut.Core2D.layers.Character', 1, []);
})();
Object.defineProperties(ut.Core2D.layers.Character, { cid: { configurable: true, get: function() { delete ut.Core2D.layers.Character.cid; var offsetsPtr = 0, offsetsCount = 0; return ut.Core2D.layers.Character.cid = Module._ut_component_register_cid_with_type(ut.Core2D.layers.Character._typeDesc, 0, 0, offsetsPtr, offsetsCount, 0, 0); } } });
Object.defineProperties(ut.Core2D.layers.Character.StorageView, { cid: { configurable: true, get: function() { return ut.Core2D.layers.Character.cid; } } });
ut.Core2D.layers.Foreground = function() {
};
ut.Core2D.layers.Foreground.prototype = Object.create(null);
ut.Core2D.layers.Foreground.prototype.constructor = ut.Core2D.layers.Foreground;
Object.defineProperties(ut.Core2D.layers.Foreground.prototype, {
});
ut.Core2D.layers.Foreground._size = 1;
ut.Core2D.layers.Foreground._fromPtr = function(ptr, v) {
  v = v || Object.create(ut.Core2D.layers.Foreground.prototype);
  return v;
};
ut.Core2D.layers.Foreground._toPtr = function(ptr, v) {
};
ut.Core2D.layers.Foreground._toTempHeapPtr = function(ptr, v) {
};
ut.Core2D.layers.Foreground._tempHeapPtr = function(v) {
  var ptr = ut.tempHeapPtrBufferZero(1);
  if (v) ut.Core2D.layers.Foreground._toTempHeapPtr(ptr, v);
  return ptr;
};
ut.Core2D.layers.Foreground.StorageView = function(ptr) {
  this._ptr = ptr;
};
ut.Core2D.layers.Foreground.StorageView.prototype = Object.create(null);
ut.Core2D.layers.Foreground.StorageView.prototype.constructor = ut.Core2D.layers.Foreground.StorageView;
ut.Core2D.layers.Foreground._view = ut.Core2D.layers.Foreground.StorageView;
ut.Core2D.layers.Foreground.StorageView._isSharedComp = ut.Core2D.layers.Foreground._isSharedComp = false;
ut.Core2D.layers.Foreground.StorageView._fromPtr = ut.Core2D.layers.Foreground._fromPtr;
ut.Core2D.layers.Foreground.StorageView._toPtr = ut.Core2D.layers.Foreground._toPtr;
ut.Core2D.layers.Foreground.StorageView._tempHeapPtr = ut.Core2D.layers.Foreground._tempHeapPtr;
ut.Core2D.layers.Foreground.StorageView._size = ut.Core2D.layers.Foreground._size;
ut.Core2D.layers.Foreground.StorageView.prototype.$advance = function() {
  this._ptr += 1;
};
Object.defineProperties(ut.Core2D.layers.Foreground.StorageView.prototype, {
});
ut.Core2D.layers.Foreground._dtorFn = function dtor(ptr) { /* POD, no-op */ }
// ut.Core2D.layers.Foreground is a POD type, so a JavaScript side copy constructor ut.Core2D.layers.Foreground._copyFn = function copy(src, dst) { ... } does not need to be generated for it
ut.Core2D.layers.Foreground._typeDesc = (function() {
  return ut.meta.allocType(5, 'ut.Core2D.layers.Foreground', 1, []);
})();
Object.defineProperties(ut.Core2D.layers.Foreground, { cid: { configurable: true, get: function() { delete ut.Core2D.layers.Foreground.cid; var offsetsPtr = 0, offsetsCount = 0; return ut.Core2D.layers.Foreground.cid = Module._ut_component_register_cid_with_type(ut.Core2D.layers.Foreground._typeDesc, 0, 0, offsetsPtr, offsetsCount, 0, 0); } } });
Object.defineProperties(ut.Core2D.layers.Foreground.StorageView, { cid: { configurable: true, get: function() { return ut.Core2D.layers.Foreground.cid; } } });
